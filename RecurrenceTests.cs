...
namespace RecurrenceCalculator.Tests
{
    ...
    public class RecurrenceTests
    {
        ...
        public void Should_Generate_Daily_Recurrences_With_End_Date()
        {
            ...
            recurrence.EndDate = new DateTime(2016, 3, 19);
            var occurrences = _calendarUtility.CalculateOccurrences(recurrence).ToList();
            Assert.AreEqual(13, occurrences.Count, "Should create 13 occurrences");
            for (int i = 0; i < occurrences.Count - 1; i++)
            {
                Assert.AreEqual(_startDate.AddDays(i * recurrence.Interval), occurrences[i], "Should have correct date");
            }
        ...
        public void Should_Generate_Daily_Weekday_Recurrences_Without_End_Date()
        {
            ...
            Assert.AreEqual(new DateTime(2016, 2, 24).Add(_startDate.TimeOfDay), occurrences[0], "First date should be correct");
            Assert.AreEqual(new DateTime(2016, 2, 26).Add(_startDate.TimeOfDay), occurrences[1], "Second date should be correct");
            Assert.AreEqual(new DateTime(2016, 3, 1).Add(_startDate.TimeOfDay), occurrences[2], "Third date should be correct");
        }
